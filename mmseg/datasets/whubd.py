...
class WHUBuildingDatasetS1(CustomDataset):
    """
    WHUBuildingDatasetS1:
    http://gpcv.whu.edu.cn/data/building_dataset.html
    Satellite dataset Ⅰ (global cities)
...
@DATASETS.register_module()
class WHUBuildingDatasetS2(CustomDataset):
    """
    WHUBuildingDatasetS2:
    http://gpcv.whu.edu.cn/data/building_dataset.html
    ...
    def __init__(self, **kwargs):
        super(WHUBuildingDatasetS2, self).__init__(
            img_suffix='.png',
            seg_map_suffix='.png',
            ignore_index=255,
            **kwargs)
